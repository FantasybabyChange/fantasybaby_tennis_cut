...
VIDEO_TYPE_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "2": {
        ...
        **MATCH_OPTIMIZED_PRESET,
        "hysteresis_start_threshold": 0.42,
        "hysteresis_continue_threshold": 0.24,
        "max_inactive_seconds": 2.8,
        "quality_trim_threshold": 0.24,
        "strong_tail_trim_peak_threshold": 0.0,
        "strong_tail_trim_min_tail_seconds": 0.0,
        "audio_tail_trim_min_segment_seconds": 0.0,
        "audio_silent_gap_trim_min_segment_seconds": 0.0,
        "audio_bridge_gap_seconds": 10.0,
        "audio_bridge_peak_threshold": 0.45,
        "audio_bridge_min_peak_count": 1,
        "audio_soft_bridge_gap_seconds": 24.0,
        "audio_soft_bridge_peak_threshold": 0.40,
        "audio_soft_bridge_min_peak_count": 1,
        "audio_soft_bridge_min_previous_seconds": 12.0,
        "audio_soft_bridge_min_next_seconds": 8.0,
        "audio_gap_rescue_gap_seconds": 30.0,
        "audio_gap_rescue_peak_threshold": 0.55,
        "audio_gap_rescue_min_peak_count": 1,
        "audio_gap_rescue_min_peak_span_seconds": 0.4,
        "audio_gap_rescue_pre_padding_seconds": 3.5,
        "audio_gap_rescue_post_padding_seconds": 2.5,
        "visual_audio_gap_rescue_max_gap_seconds": 120.0,
        "visual_audio_gap_rescue_min_anchor_seconds": 10.0,
        "visual_audio_gap_rescue_visual_threshold": 0.22,
        "visual_audio_gap_rescue_min_visual_seconds": 4.0,
        "visual_audio_gap_rescue_audio_threshold": 0.45,
        "visual_audio_gap_rescue_min_audio_peaks": 2,
        "visual_audio_gap_rescue_min_audio_span_seconds": 3.0,
        "visual_audio_soft_bridge_gap_seconds": 36.0,
        "visual_audio_soft_bridge_visual_threshold": 0.22,
        "visual_audio_soft_bridge_min_visual_seconds": 3.0,
        "visual_audio_soft_bridge_audio_threshold": 0.40,
        "visual_audio_soft_bridge_min_audio_peaks": 2,
        "visual_audio_soft_bridge_min_audio_span_seconds": 2.0,
        "visual_audio_soft_bridge_min_combined_seconds": 16.0,
        "merge_gap_seconds": 2.4,
        "final_continuity_merge_gap_seconds": 14.0,
        "pre_roll_seconds": 1.2,
        "post_roll_seconds": 2.2,
        "serve_pre_roll_seconds": 2.8,
        "serve_pre_roll_gap_seconds": 8.0,
        "model_ball_sample_fps": 3.0,
        "model_ball_confidence": 0.15,
        "model_ball_bridge_min_confidence": 0.25,
        "model_ball_candidate_gap_seconds": 45.0,
        "model_ball_max_gap_seconds": 14.0,
        "model_ball_min_active_seconds": 2.0,
        "model_ball_min_detections": 2,
        "model_ball_min_motion_ratio": 0.0035,
        "model_ball_bridge_padding_seconds": 5.0,
        "model_ball_max_bridges": 0,
        "model_ball_rescue_missing_rallies": True,
        "model_ball_rescue_gap_seconds": 9999.0,
        "model_ball_complete_rally_guard": True,
        "model_ball_complete_rally_gap_seconds": 14.0,
    ...
    "3": {
        ...
        **MATCH_OPTIMIZED_PRESET,
        ...
        "model_ball_rescue_gap_seconds": 9999.0,
        "model_ball_complete_rally_guard": True,
        "model_ball_complete_rally_gap_seconds": 7.0,
        "prefer_stream_copy": False,
        "preserve_source_bitrate": True,
        "fallback_preset": "veryfast",
    },
